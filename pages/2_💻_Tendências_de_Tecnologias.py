...
# # ==============================================================================
# # Gráfico 3.2: Popularidade das Ferramentas de BI (COM RÓTULOS NAS BARRAS)
# # ==============================================================================
...
#     bi_default = pop_bi_2024_sorted.head(4).index.tolist()
...
#         # 💡 ADICIONADO 'text=popularidade_pct' 💡
#         fig_bi = px.bar(
#             df_plotar_bi,
#             x='ano',
#             y='popularidade_pct',
#             color='ferramenta_bi',
#             barmode='group',
#             text='popularidade_pct', # <-- 💡 ADICIONADO AQUI
#             category_orders={
#                 'ferramenta_bi': ordem_ferramentas,
#                 'ano': [2021, 2023, 2024]
#             },
...
#             texttemplate='%{y:.2f}%', # Formato do texto (ex: 38.3%)
